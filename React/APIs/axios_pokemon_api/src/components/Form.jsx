...
/**
 * The form component for fetching entries from the PokeAPI. 
 * 
...
const Form = (props) => {
    ...
    /**
     * Handles form submission by calling the fetchData() function from App.js
     * via props (key of onSubmission) and clears the text inputs by reseting
     * the two state variables to empty strings.
     * 
